			...
			<form action="uploadphotos.php" method="POST" enctype="multipart/form-data" id="UploadForm">
				<table>
					<tr>
						...
						<td class="photo_thump_td"><img id="uploadPreview1" class="photo_thump"/></td>
					</tr>
					<tr>
						<td>Εικόνα 2 : </td>
						<td><input id="uploadImage2" name="ImageFile2" type="file" onchange="PreviewImage(2);"/></td>
						<td class="photo_thump_td"><img id="uploadPreview2" class="photo_thump"/></td>
					</tr>
					<tr>
						<td>Εικόνα 3 : </td>
						<td><input id="uploadImage3" name="ImageFile3" type="file" onchange="PreviewImage(3);"/></td>
						<td class="photo_thump_td"><img id="uploadPreview3" class="photo_thump"/></td>
					</tr>
					<tr>
						<td>Εικόνα 4 : </td>
						<td><input id="uploadImage4" name="ImageFile4" type="file" onchange="PreviewImage(4);"/></td>
						<td class="photo_thump_td"><img id="uploadPreview4" class="photo_thump"/></td>
					</tr>
				</table>
